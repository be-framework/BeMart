DELETE FROM dtb_csv WHERE csv_type_id = :csvType;
...
SELECT :csvType, jt.column_name, jt.column_name, jt.column_name, jt.sort_no, jt.enabled, NOW(), NOW(), 'csv'
FROM JSON_TABLE(:entries, '$[*]' COLUMNS (
