...
/**
 * Phase 3 — HTML render check for the admin 店舗基本情報
 * Setting/Shop Tier-2 page (`shop_master.twig`).
 *
 ...
 * {@see \MyVendor\BeMart\Resource\Page\Admin\BaseInfo}. The EC-CUBE
...
final class AdminBaseInfoHtmlRenderTest extends TestCase
{
    ...
    public function testBaseInfoRendersAsHtmlDocument(): void
    {
