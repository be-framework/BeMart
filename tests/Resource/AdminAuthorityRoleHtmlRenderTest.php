...
/**
 * Phase 3 — HTML render check for the admin 権限管理 Tier-2 page.
 *
 * Render-smoke standard: the page renders a full admin-frame HTML
 * document through {@see HtmlModule} with the authority-rule editor
 * body supplied by {@see \MyVendor\BeMart\Resource\Page\Admin\AuthorityRole}
 * `onGet()`. The EC-CUBE residual-diff fidelity check is a follow-up
...
final class AdminAuthorityRoleHtmlRenderTest extends TestCase
{
    ...
    public function testAuthorityRoleRendersAsHtmlDocument(): void
    {
    ...
    public function testAuthorityRolePreservesEcCubeAdminMarkupStructure(): void
    {
