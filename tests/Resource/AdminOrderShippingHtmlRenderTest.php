...
/**
 * Phase 3 — HTML render check for the admin 出荷登録 Order Tier-2 page.
 *
 ...
 * {@see \MyVendor\BeMart\Resource\Page\Admin\Order\ShippingAddress}.
 * The blank shipping editor renders with empty Fake storage, so the
 * smoke test needs no seed. The EC-CUBE residual-diff fidelity check
 * is a follow-up gated on the EC-CUBE 4.3 reference clone
...
final class AdminOrderShippingHtmlRenderTest extends TestCase
{
    ...
    public function testOrderShippingPreservesEcCubeAdminMarkupStructure(): void
    {
