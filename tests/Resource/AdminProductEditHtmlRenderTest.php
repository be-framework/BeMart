...
/**
 * Phase 3 — HTML render check for the admin 商品登録 Product Tier-2 page.
 *
 ...
 * {@see \MyVendor\BeMart\Resource\Page\Admin\Product\Edit}. The blank
 * "new product" editor is exercised — it renders with empty Fake
...
final class AdminProductEditHtmlRenderTest extends TestCase
{
    ...
    public function testProductEditRendersAsHtmlDocument(): void
    {
    ...
    public function testProductEditPreservesEcCubeAdminMarkupStructure(): void
    {
