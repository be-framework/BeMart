...
/**
 * Phase 3 — HTML render check for the admin 受注メール送信 Order Tier-2 page.
 *
 ...
 * {@see \MyVendor\BeMart\Resource\Page\Admin\Order\SendMail}. The
 * composition form renders with empty Fake storage, so the smoke test
...
final class AdminOrderMailHtmlRenderTest extends TestCase
{
    ...
    public function testOrderMailRendersAsHtmlDocument(): void
    {
    ...
    public function testOrderMailPreservesEcCubeAdminMarkupStructure(): void
    {
