...
/**
 * Phase 3 — HTML render check for the admin メール設定 Setting/Shop Tier-2 page.
 *
 ...
 * {@see \MyVendor\BeMart\Resource\Page\Admin\MailTemplate}. The
...
final class AdminMailTemplateHtmlRenderTest extends TestCase
{
    ...
    public function testMailTemplateRendersAsHtmlDocument(): void
    {
    ...
    public function testMailTemplatePreservesEcCubeAdminMarkupStructure(): void
    {
