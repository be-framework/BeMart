...
/**
 * Phase 3 — HTML render check for the admin カテゴリ登録 Product Tier-2 page.
 *
 ...
 * {@see \MyVendor\BeMart\Resource\Page\Admin\Category\Edit}. The blank
 * "新規カテゴリ" editor is exercised — it renders with empty Fake
...
final class AdminCategoryEditHtmlRenderTest extends TestCase
{
    ...
    public function testCategoryEditRendersAsHtmlDocument(): void
    {
    ...
    public function testCategoryEditPreservesEcCubeAdminMarkupStructure(): void
    {
