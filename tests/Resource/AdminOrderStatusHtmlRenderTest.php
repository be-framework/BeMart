...
/**
 * Phase 3 — HTML render check for the admin 受注対応状況設定 Setting/Shop Tier-2 page.
 *
 ...
 * {@see \MyVendor\BeMart\Resource\Page\Admin\OrderStatus}. The
...
final class AdminOrderStatusHtmlRenderTest extends TestCase
{
    ...
    public function testOrderStatusRendersAsHtmlDocument(): void
    {
    ...
    public function testOrderStatusPreservesEcCubeAdminMarkupStructure(): void
    {
