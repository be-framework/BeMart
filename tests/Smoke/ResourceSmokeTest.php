...
final class ResourceSmokeTest extends TestCase
{
    ...
    public static function resourceProvider(): array
    {
        return self::normalize([
            ...
            'GET page://self/products' => Code::OK,
            ...
            'POST page://self/admin/change-password?currentPassword=admin-test-password-2026&changePasswordFirst=new-strong-password-2026&changePasswordSecond=new-strong-password-2026' => Code::OK,
            ...
            'POST page://self/admin/login?loginId=test-admin&password=admin-test-password-2026' => Code::OK,
            'POST page://self/admin/logout' => Code::OK,
            ...
            'POST page://self/admin/template/template-add?templateCode=mytheme&templateName=My%20Theme' => Code::OK,
            ...
            'POST page://self/login?email=login-test%40example.com&password=login-test-password-2026' => Code::OK,
            'POST page://self/logout' => Code::OK,
