...
final class ResourceSmokeTest extends TestCase
{
    ...
    public static function resourceProvider(): array
    {
        return self::normalize([
            ...
            'POST page://self/admin/login?loginId=test-admin&password=local-dev-admin-password' => Code::SEE_OTHER,
            ...
            'POST page://self/admin/two-factor-auth?loginId=test-admin&deviceToken=123456' => Code::SEE_OTHER,
