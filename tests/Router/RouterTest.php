...
final class RouterTest extends TestCase
{
    ...
    public function testEntryConfirmPageIsDisplayable(): void
    {
        ...
        [$postedRoute, $postedMetadata] = $this->match('POST', '/entry/confirm');

        $this->assertSame('entry_confirm', $postedRoute->name);
        $this->assertSame('page://self/entry/confirm', $postedMetadata['resource']);
        $this->assertSame('get', $postedMetadata['dispatchMethod']);
    }
