...
| paymentMethodId | int | 支払方法ID - 非会員購入で作成した仮注文に紐づく支払方法ID。次の注文確認遷移 doConfirmOrder へ渡す。 | Optional | {"$ref":"#/$defs/dbId"} |  |
