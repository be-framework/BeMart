...
|------|------|-------------|----------|-------------|---------|
| tradeLawBody | string|null | 特定商取引法本文 - 特定商取引法ページ本文の単一ブロブ投影。項目別行ではなく、ページ全体を1本の本文として扱う。 | Required | {"minLength":0,"maxLength":65535} |  |
...
|------|------|-------------|---------|----------|-------------|---------|
| tradeLawBody | string | 特定商取引法本文（入力） - 特定商取引法ページ本文の単一ブロブ投影。項目別行ではなく、ページ全体を1本の本文として扱う。 |  | Optional | {"minLength":0,"maxLength":65535,"$comment":"Request schema is transport-level; business invalid values are allowed through to Resource/Semantic validation."} |  |
| mode | string | HTMLフォーム送信時のPRG mode。 |  | Optional | {"enum":["trade_law_form",null]} |  |
| trade_law_1_name | string |  |  | Optional |  |  |
| trade_law_1_description | string |  |  | Optional |  |  |
| trade_law_1_displayOrderScreen | string |  |  | Optional |  |  |
| trade_law_2_name | string |  |  | Optional |  |  |
| trade_law_2_description | string |  |  | Optional |  |  |
| trade_law_2_displayOrderScreen | string |  |  | Optional |  |  |
| trade_law_3_name | string |  |  | Optional |  |  |
| trade_law_3_description | string |  |  | Optional |  |  |
| trade_law_3_displayOrderScreen | string |  |  | Optional |  |  |
| trade_law_4_name | string |  |  | Optional |  |  |
| trade_law_4_description | string |  |  | Optional |  |  |
| trade_law_4_displayOrderScreen | string |  |  | Optional |  |  |
| trade_law_5_name | string |  |  | Optional |  |  |
| trade_law_5_description | string |  |  | Optional |  |  |
| trade_law_5_displayOrderScreen | string |  |  | Optional |  |  |
| trade_law_6_name | string |  |  | Optional |  |  |
| trade_law_6_description | string |  |  | Optional |  |  |
| trade_law_6_displayOrderScreen | string |  |  | Optional |  |  |
