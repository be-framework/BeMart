...
| csrfToken | string | CSRFトークン - フォーム送信元を検証するトークン。管理者向けマスタデータ選択フォームに使用。 | Optional | {"minLength":1,"maxLength":160} |  |
...
| csrfToken | string | CSRFトークン - フォーム送信元を検証するトークン。管理者向けマスタデータ編集フォームに使用。 | Optional | {"minLength":1,"maxLength":160} |  |
