...
| csrfToken | string|null | CSRFトークン - 受注登録/編集フォーム送信用のCSRFトークン。Resource bodyからTwig hidden inputへ渡される。 | Optional | {"minLength":0,"maxLength":160,"pattern":"^[A-Za-z0-9_.:-]*$","$comment":"CSRF\u5024\u306fRay.Csrf CsrfToken\u5883\u754c\u306e\u8cac\u52d9\u3002GET body\u3067\u306f\u30d5\u30a9\u30fc\u30e0\u6587\u8108\u3092\u793a\u3059\u305f\u3081\u306bnull\u3092\u8a31\u5bb9\u3059\u308b\u3002"} |  |
