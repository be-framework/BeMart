...
| previousAuthority | int|null | 処理派生項目 - /admin/authority-role の処理文脈から派生した処理派生項目。ALPS基礎語だけでは単位や用途が不足するため、このResource上の意味を明示する。 | Required | {"minimum":0} |  |
...
| changed | boolean | 処理状態フラグ - Fake観察数値 1〜1; 観察値 '1'。 | Required |  | 1 |
