...
| csrfToken | string|null | CSRFトークン - 一覧画面から送信する削除・表示切替フォーム用のCSRFトークン。 | Required | {"minLength":0,"maxLength":160,"pattern":"^[A-Za-z0-9_.:-]*$"} |  |
...
| doToggleVisible | [<code>page://self/admin/toggle-visible</code>](/admin/toggle-visible.md) |
