...
| file |  | テンプレートファイル - multipart/form-data の `file` または Resource テストで渡される FileUpload オブジェクト。詳細検証は `#[InputFile]` が担う。 |  | Optional | {"$comment":"Koriym\\FileUpload\\FileUpload / ErrorFileUpload \u306f schema \u3067\u306f\u4e0d\u900f\u660e\u30aa\u30d6\u30b8\u30a7\u30af\u30c8\u3068\u3057\u3066\u6271\u3046\u3002"} |  |
...
| archiveName | string|null | テンプレートアーカイブ名 - アップロードされたテンプレートzipのファイル名。 | Optional | {"minLength":0,"maxLength":255} |  |
| archiveSize | int|null | テンプレートアーカイブサイズ - アップロードされたテンプレートzipのバイトサイズ。 | Optional | {"minimum":0,"maximum":10485760} |  |
