...
| 境界ルールを再利用する | [`methodology/architecture-audit-baseline.md`](methodology/architecture-audit-baseline.md) → [`skills/index.md`](skills/index.md) → [`methodology/`](methodology/) |
...
| ディレクトリ | 内容 |
|---|---|
| [`methodology/`](methodology/) | 再利用可能な方法論・原則。`architecture-audit-baseline.md`（BEAR境界標準逸脱の監査baseline）、`hypermedia-test-principle.md`（hypermedia テスト＝移植契約）、`FRAMEWORK_REVIEW.md`（元139 transition sliceの歴史的フレームワーク実務レビュー）、`be-bear-ai-era.md`（Be + BEAR の AI コーディング時代における潜在能力の論評）。 |
