...
| flow-purchase (cart→checkout) | ✓ 17 | ✓ (`doCreateOrder` full: PurchaseFlow + item snapshot; storefront snapshot follow-up) | ✓ | ✓ | ✓ storefront |
