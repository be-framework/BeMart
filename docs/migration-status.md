...
| 3. BEAR Resource / Router | 259 RouteTable entries / 293 method entries | Every public HTML route method has an ALPS descriptor (`293/293`). Concrete Resource dispatch is available for 234 method entries; 59 method entries intentionally use `ActionRedirect` as a safe fallback/return transition and are marked partial in the feature table. |
