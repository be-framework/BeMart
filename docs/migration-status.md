...
| 2. Be domain (`be/src`) | 144/144 transitions | Phase A migrated 139 transitions; Phase-3 remediation added all 5 (`doSortNoMove` / `doToggleVisible` / `doUpdateTrackingNumber` / `doSendShippingNotifyMail` / `doResendActivationMail`). 7 Phase-A transitions are functional **stubs**. 129 Final / 128 Input / 137 Semantic / 14 Being / 38 Entity. |
