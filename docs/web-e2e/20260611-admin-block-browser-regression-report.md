# 20260611-admin-block-browser-regression Web+DB 全ルート検証結果
...
- DB: `bemart_e2e_block_20260611` (`DATABASE_URL`)
- Fake JSON / Fake context / 直接DB seed: **未使用前提**。runner は Web/HTTP 境界のみを操作し、SQL fixture は投入しない。
- Feature matrix: pass 153 / fail 31 / 対象外 2
- OpenAPI operations: pass 154 / fail 80 / 対象外 3 / total 237
- NG cases: pass 0 / fail 0 / total 0
- screenshots: `docs/web-e2e/screenshots/20260611-admin-block-browser-regression/`
- results JSON: `docs/web-e2e/results/20260611-admin-block-browser-regression.json`
...
- 業務状態作成: pass product=`we-mq8th1sq-opdu39` memberOrder=`4d9558f1e0eeb3623ec66fba7d2e38a3` nonMemberOrder=`9011641d91c2318de56a387b69e2387d`
- ✔ pass setup:admin-base-info-update final=`http://127.0.0.1:18080/admin/base-info` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-base-info-update.png`
- ✔ pass setup:admin-cache-clear final=`http://127.0.0.1:18080/admin/content/cache` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-cache-clear.png`
- ✔ pass setup:admin-maintenance-toggle final=`http://127.0.0.1:18080/admin/content/maintenance` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-maintenance-enable.png`
- ✔ pass setup:admin-news-create final=`http://127.0.0.1:18080/admin/news/news?newsId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-news-create.png`
- ✔ pass setup:admin-news-update final=`http://127.0.0.1:18080/admin/news/news?newsId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-news-update.png`
- ✔ pass setup:admin-news-delete final=`http://127.0.0.1:18080/admin/news/news-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-news-delete.png`
- ✔ pass setup:admin-page-create final=`http://127.0.0.1:18080/admin/page/page?pageId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-page-create.png`
- ✔ pass setup:admin-page-update final=`http://127.0.0.1:18080/admin/page/page?pageId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-page-update.png`
- ✔ pass setup:admin-page-delete final=`http://127.0.0.1:18080/admin/page/page-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-page-delete.png`
- ✔ pass setup:admin-block-create final=`http://127.0.0.1:18080/admin/block/block-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-block-create.png`
- ✔ pass setup:admin-block-delete final=`http://127.0.0.1:18080/admin/block/block-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-block-delete.png`
- ✔ pass setup:admin-member-maintenance final=`http://127.0.0.1:18080/admin/member-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-member-delete.png`
- ✔ pass setup:admin-security-update final=`http://127.0.0.1:18080/admin/security` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-security-update.png`
- ✔ pass setup:admin-two-factor-verify final=`http://127.0.0.1:18080/admin/index` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-two-factor-verify.png`
- ✔ pass setup:admin-payment-maintenance-create final=`http://127.0.0.1:18080/admin/payment/payment?paymentId=3` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-payment-maintenance-create.png`
- ✔ pass setup:admin-payment-maintenance-update final=`http://127.0.0.1:18080/admin/payment/payment?paymentId=3` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-payment-maintenance-update.png`
- ✔ pass setup:admin-payment-maintenance-delete final=`http://127.0.0.1:18080/admin/payment/payment-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-payment-maintenance-delete.png`
- ✔ pass setup:admin-delivery-maintenance-create final=`http://127.0.0.1:18080/admin/delivery/delivery?deliveryId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-delivery-maintenance-create.png`
- ✔ pass setup:admin-delivery-maintenance-update final=`http://127.0.0.1:18080/admin/delivery/delivery?deliveryId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-delivery-maintenance-update.png`
- ✔ pass setup:admin-delivery-maintenance-delete final=`http://127.0.0.1:18080/admin/delivery/delivery-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-delivery-maintenance-delete.png`
- ✔ pass setup:admin-tax-rule-create final=`http://127.0.0.1:18080/admin/tax-rule/tax-rule-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-tax-rule-create.png`
- ✔ pass setup:admin-tax-rule-delete final=`http://127.0.0.1:18080/admin/tax-rule/tax-rule-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-tax-rule-delete.png`
- ✔ pass setup:admin-calendar-holiday-create final=`http://127.0.0.1:18080/admin/calendar` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-calendar-holiday-create.png`
- ✔ pass setup:admin-calendar-holiday-update final=`http://127.0.0.1:18080/admin/calendar` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-calendar-holiday-create.png`
- ✔ pass setup:admin-calendar-holiday-delete final=`http://127.0.0.1:18080/admin/calendar` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-calendar-holiday-delete.png`
- ✔ pass setup:admin-class-name-create final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-class-name-create.png`
- ✔ pass setup:admin-class-name-update final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-class-name-update.png`
- ✔ pass setup:admin-class-category-create final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-class-category-create.png`
- ✔ pass setup:admin-class-category-update final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-class-category-update.png`
- ✔ pass setup:admin-class-category-delete final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-class-category-delete.png`
- ✔ pass setup:admin-class-name-delete final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-class-name-delete.png`
- ✔ pass setup:admin-product-create final=`/admin/product?productCode=we-mq8th1sq-opdu39` screenshot=``
- ✔ pass setup:admin-product-readback final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8th1sq-opdu39` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-product-readback.png`
- ✔ pass setup:admin-product-csv-upload final=`http://127.0.0.1:18080/admin/product?productCode=we-csv-f48dud43` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-product-csv-upload.png`
- ✔ pass setup:admin-product-update final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8th1sq-opdu39` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-product-update.png`
- ✔ pass setup:admin-product-copy final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8th1sq-opdu39-copy` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-product-copy.png`
- ✔ pass setup:admin-product-bulk-status final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8th1sq-opdu39-copy` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-product-bulk-status.png`
- ✔ pass setup:admin-product-delete-copy final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8th1sq-opdu39-copy` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-product-delete-copy.png`
- ✔ pass setup:admin-category-create final=`http://127.0.0.1:18080/admin/category/category?categoryId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-category-create.png`
- ✔ pass setup:admin-category-update final=`http://127.0.0.1:18080/admin/category/category?categoryId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-category-update.png`
- ✔ pass setup:admin-category-delete final=`http://127.0.0.1:18080/admin/category/category-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-category-delete.png`
- ✔ pass setup:admin-category-csv-upload final=`http://127.0.0.1:18080/admin/category/category-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-category-csv-upload.png`
- ✔ pass setup:admin-class-name-csv-upload final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-class-name-csv-upload.png`
- ✔ pass setup:admin-class-category-csv-upload final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-class-category-csv-upload.png`
- ✔ pass setup:admin-tag-create final=`http://127.0.0.1:18080/admin/tag/tag-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-tag-create.png`
- ✔ pass setup:admin-tag-delete final=`http://127.0.0.1:18080/admin/tag/tag-list` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-tag-delete.png`
- ✔ pass setup:admin-customer-create final=`/admin/customer?email=admin-customer-ypkx6r%40example.test` screenshot=``
- ✔ pass setup:admin-customer-readback final=`http://127.0.0.1:18080/admin/customer-list?emailKeyword=admin-customer-ypkx6r%40example.test` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-customer-readback.png`
- ✔ pass setup:admin-customer-delete final=`http://127.0.0.1:18080/admin/customer-list?emailKeyword=admin-customer-ypkx6r%40example.test` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-customer-delete.png`
- ✔ pass setup:admin-logout final=`/admin/login` screenshot=``
- ✔ pass setup:storefront-product-readback final=`http://127.0.0.1:18080/product?productCode=we-mq8th1sq-opdu39` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/storefront-product-readback.png`
- ✔ pass setup:non-member-purchase final=`http://127.0.0.1:18080/shopping/complete?orderNo=9011641d91c2318de56a387b69e2387d` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/non-member-purchase-complete.png`
- ✔ pass setup:customer-login final=`http://127.0.0.1:18080/mypage` screenshot=``
- ✔ pass setup:member-purchase-history-reorder final=`http://127.0.0.1:18080/cart` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/member-reorder-cart.png`
- ✔ pass setup:admin-order-update final=`http://127.0.0.1:18080/admin/order?orderNo=4d9558f1e0eeb3623ec66fba7d2e38a3` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-order-update.png`
- ✔ pass setup:admin-order-status-update final=`http://127.0.0.1:18080/admin/order?orderNo=4d9558f1e0eeb3623ec66fba7d2e38a3` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-order-status-update.png`
- ✔ pass setup:admin-order-shipping-address-update final=`http://127.0.0.1:18080/admin/order/shipping-address?orderNo=4d9558f1e0eeb3623ec66fba7d2e38a3` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-order-shipping-address-update.png`
- ✔ pass setup:admin-order-tracking-number-update final=`/admin/order/tracking-number?orderNo=4d9558f1e0eeb3623ec66fba7d2e38a3&_method=put` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-order-tracking-number-update.png`
- ✔ pass setup:admin-order-shipping-csv-import final=`http://127.0.0.1:18080/admin/order/import-shipping` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-order-shipping-csv-import.png`
- ✔ pass setup:admin-order-shipping-notify-send final=`/admin/order/shipping-notify-mail` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-order-shipping-notify-send.png`
- ✔ pass setup:admin-order-mail-send final=`/admin/order/send-mail?orderNo=4d9558f1e0eeb3623ec66fba7d2e38a3` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/admin-order-mail-send.png`
- ✔ pass setup:cart-quantity-and-delete final=`http://127.0.0.1:18080/cart` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/cart-quantity-and-delete.png`
- ✔ pass setup:customer-profile-favorite-address final=`http://127.0.0.1:18080/mypage` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/customer-profile-favorite-address.png`
- ✔ pass setup:customer-logout-and-relogin final=`http://127.0.0.1:18080/mypage` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/customer-logout-and-relogin.png`
- ✔ pass setup:contact-submit final=`http://127.0.0.1:18080/contact/complete?ticketId=INQ-6a2a0f573b1683.63083879` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/contact-submit.png`
- ✔ pass setup:password-reset-request final=`` screenshot=``
- ✔ pass setup:customer-withdraw final=`http://127.0.0.1:18080/mypage/withdraw-complete` screenshot=`screenshots/20260611-admin-block-browser-regression/setup/customer-withdraw.png`
...
- 083 Admin 商品規格編集: ✘ fail（unsafe operation not executed: PUT /admin/product/product-class） final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8th1sq-opdu39` reason=Browser navigation reached the page, but PUT /admin/product/product-class was not executed as an OK scenario.
