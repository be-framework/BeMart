# 20260611-admin-member-browser-regression-cacheclear Web+DB 全ルート検証結果

> Note: this is a limited regression run executed with `--limit=142`.
...
- DB: `bemart_e2e_member_20260611_cacheclear` (`DATABASE_URL`)
- Fake JSON / Fake context / 直接DB seed: **未使用前提**。runner は Web/HTTP 境界のみを操作し、SQL fixture は投入しない。
- Feature matrix: pass 123 / fail 61 / 対象外 2
- OpenAPI operations: pass 125 / fail 109 / 対象外 3 / total 237
- NG cases: pass 0 / fail 0 / total 0
- screenshots: `docs/web-e2e/screenshots/20260611-admin-member-browser-regression-cacheclear/`
- results JSON: `docs/web-e2e/results/20260611-admin-member-browser-regression-cacheclear.json`
...
- 業務状態作成: fail product=`we-mq8peky8-udjkim` memberOrder=`201360d33203c6202aac674be2eb46e3` nonMemberOrder=`46abf2a5ed9c5f2229f69bb2f4728db4`
- ✔ pass setup:admin-base-info-update final=`http://127.0.0.1:18080/admin/base-info` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-base-info-update.png`
- ✔ pass setup:admin-cache-clear final=`http://127.0.0.1:18080/admin/content/cache` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-cache-clear.png`
- ✔ pass setup:admin-maintenance-toggle final=`http://127.0.0.1:18080/admin/content/maintenance` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-maintenance-enable.png`
- ✔ pass setup:admin-member-maintenance final=`http://127.0.0.1:18080/admin/member-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-member-delete.png`
- ✔ pass setup:admin-payment-maintenance-create final=`http://127.0.0.1:18080/admin/payment/payment?paymentId=3` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-payment-maintenance-create.png`
- ✔ pass setup:admin-payment-maintenance-update final=`http://127.0.0.1:18080/admin/payment/payment?paymentId=3` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-payment-maintenance-update.png`
- ✔ pass setup:admin-payment-maintenance-delete final=`http://127.0.0.1:18080/admin/payment/payment-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-payment-maintenance-delete.png`
- ✔ pass setup:admin-delivery-maintenance-create final=`http://127.0.0.1:18080/admin/delivery/delivery?deliveryId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-delivery-maintenance-create.png`
- ✔ pass setup:admin-delivery-maintenance-update final=`http://127.0.0.1:18080/admin/delivery/delivery?deliveryId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-delivery-maintenance-update.png`
- ✔ pass setup:admin-delivery-maintenance-delete final=`http://127.0.0.1:18080/admin/delivery/delivery-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-delivery-maintenance-delete.png`
- ✔ pass setup:admin-tax-rule-create final=`http://127.0.0.1:18080/admin/tax-rule/tax-rule-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-tax-rule-create.png`
- ✔ pass setup:admin-tax-rule-delete final=`http://127.0.0.1:18080/admin/tax-rule/tax-rule-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-tax-rule-delete.png`
- ✔ pass setup:admin-class-name-create final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-class-name-create.png`
- ✔ pass setup:admin-class-name-update final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-class-name-update.png`
- ✔ pass setup:admin-class-category-create final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-class-category-create.png`
- ✔ pass setup:admin-class-category-update final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-class-category-update.png`
- ✔ pass setup:admin-class-category-delete final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-class-category-delete.png`
- ✔ pass setup:admin-class-name-delete final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-class-name-delete.png`
- ✔ pass setup:admin-product-create final=`/admin/product?productCode=we-mq8peky8-udjkim` screenshot=``
- ✔ pass setup:admin-product-readback final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8peky8-udjkim` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-product-readback.png`
- ✔ pass setup:admin-product-csv-upload final=`http://127.0.0.1:18080/admin/product?productCode=we-csv-soh3k3kg` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-product-csv-upload.png`
- ✔ pass setup:admin-product-update final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8peky8-udjkim` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-product-update.png`
- ✔ pass setup:admin-product-copy final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8peky8-udjkim-copy` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-product-copy.png`
- ✔ pass setup:admin-product-bulk-status final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8peky8-udjkim-copy` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-product-bulk-status.png`
- ✔ pass setup:admin-product-delete-copy final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8peky8-udjkim-copy` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-product-delete-copy.png`
- ✔ pass setup:admin-category-create final=`http://127.0.0.1:18080/admin/category/category?categoryId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-category-create.png`
- ✔ pass setup:admin-category-update final=`http://127.0.0.1:18080/admin/category/category?categoryId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-category-update.png`
- ✔ pass setup:admin-category-delete final=`http://127.0.0.1:18080/admin/category/category-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-category-delete.png`
- ✔ pass setup:admin-category-csv-upload final=`http://127.0.0.1:18080/admin/category/category-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-category-csv-upload.png`
- ✔ pass setup:admin-class-name-csv-upload final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-class-name-csv-upload.png`
- ✔ pass setup:admin-class-category-csv-upload final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-class-category-csv-upload.png`
- ✔ pass setup:admin-tag-create final=`http://127.0.0.1:18080/admin/tag/tag-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-tag-create.png`
- ✔ pass setup:admin-tag-delete final=`http://127.0.0.1:18080/admin/tag/tag-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-tag-delete.png`
- ✘ fail setup:admin-customer-create final=`http://127.0.0.1:18080/admin/tag/tag-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-customer-create.png` error=Error: admin customer create failed status=400 body={"code":400,"message":"Invalid input. [email] Invalid email"}
- ✘ fail setup:admin-customer-readback final=`http://127.0.0.1:18080/admin/tag/tag-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-customer-readback.png` error=Error: admin customer location was not created
- ✘ fail setup:admin-customer-delete final=`http://127.0.0.1:18080/admin/tag/tag-list` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-customer-delete.png` error=Error: admin customer id was not created
- ✔ pass setup:admin-logout final=`/admin/login` screenshot=``
- ✔ pass setup:storefront-product-readback final=`http://127.0.0.1:18080/product?productCode=we-mq8peky8-udjkim` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/storefront-product-readback.png`
- ✔ pass setup:non-member-purchase final=`http://127.0.0.1:18080/shopping/complete?orderNo=46abf2a5ed9c5f2229f69bb2f4728db4` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/non-member-purchase-complete.png`
- ✔ pass setup:customer-login final=`http://127.0.0.1:18080/mypage` screenshot=``
- ✔ pass setup:member-purchase-history-reorder final=`http://127.0.0.1:18080/cart` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/member-reorder-cart.png`
- ✔ pass setup:admin-order-update final=`http://127.0.0.1:18080/admin/order?orderNo=201360d33203c6202aac674be2eb46e3` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-order-update.png`
- ✔ pass setup:admin-order-status-update final=`http://127.0.0.1:18080/admin/order?orderNo=201360d33203c6202aac674be2eb46e3` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-order-status-update.png`
- ✔ pass setup:admin-order-shipping-address-update final=`http://127.0.0.1:18080/admin/order/shipping-address?orderNo=201360d33203c6202aac674be2eb46e3` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-order-shipping-address-update.png`
- ✔ pass setup:admin-order-tracking-number-update final=`/admin/order/tracking-number?orderNo=201360d33203c6202aac674be2eb46e3&_method=put` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-order-tracking-number-update.png`
- ✔ pass setup:admin-order-shipping-csv-import final=`http://127.0.0.1:18080/admin/order/import-shipping` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-order-shipping-csv-import.png`
- ✔ pass setup:admin-order-shipping-notify-send final=`/admin/order/shipping-notify-mail` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-order-shipping-notify-send.png`
- ✔ pass setup:admin-order-mail-send final=`/admin/order/send-mail?orderNo=201360d33203c6202aac674be2eb46e3` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/admin-order-mail-send.png`
- ✔ pass setup:cart-quantity-and-delete final=`http://127.0.0.1:18080/cart` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/cart-quantity-and-delete.png`
- ✔ pass setup:customer-profile-favorite-address final=`http://127.0.0.1:18080/mypage` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/customer-profile-favorite-address.png`
- ✔ pass setup:customer-logout-and-relogin final=`http://127.0.0.1:18080/mypage` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/customer-logout-and-relogin.png`
- ✔ pass setup:contact-submit final=`http://127.0.0.1:18080/contact/complete?ticketId=INQ-6a29f489537390.38897519` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/contact-submit.png`
- ✔ pass setup:password-reset-request final=`` screenshot=``
- ✔ pass setup:customer-withdraw final=`http://127.0.0.1:18080/mypage/withdraw-complete` screenshot=`screenshots/20260611-admin-member-browser-regression-cacheclear/setup/customer-withdraw.png`
...
- 083 Admin 商品規格編集: ✘ fail（unsafe operation not executed: PUT /admin/product/product-class） final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8peky8-udjkim` reason=Browser navigation reached the page, but PUT /admin/product/product-class was not executed as an OK scenario.
- 084 Admin 会員一覧表示: ✘ fail（status=400 final=/admin/customer-list） final=`http://127.0.0.1:18080/admin/customer-list` reason={"code":400,"message":"Invalid input. [customers[1].email] Invalid email"}
- 085 Admin 会員検索: ✘ fail（status=400 final=/admin/customer-list） final=`http://127.0.0.1:18080/admin/customer-list` reason={"code":400,"message":"Invalid input. [customers[1].email] Invalid email"}
- 087 Admin 会員作成: ✘ fail（status=400 final=/admin/customer-list） final=`http://127.0.0.1:18080/admin/customer-list` reason={"code":400,"message":"Invalid input. [customers[1].email] Invalid email"}
- 089 Admin 会員削除: ✘ fail（unsafe operation not executed: POST /admin/delete-customer） final=`http://127.0.0.1:18080/admin/customer?customerId=1` reason=Browser navigation reached the page, but POST /admin/delete-customer was not executed as an OK scenario.
...
- ... 29 more operation failures are in the JSON.
