# 20260611-admin-member-browser-regression-fixed2 Web+DB 全ルート検証結果
...
- DB: `bemart_e2e_member_20260611` (`DATABASE_URL`)
...
- screenshots: `docs/web-e2e/screenshots/20260611-admin-member-browser-regression-fixed2/`
- results JSON: `docs/web-e2e/results/20260611-admin-member-browser-regression-fixed2.json`
...
- 業務状態作成: fail product=`we-mq8ovkj2-e2liwc` memberOrder=`7589e473118d5688f58474a165ba4e57` nonMemberOrder=`ff5aa2742601ad02b5b4f19b46a752e4`
- ✔ pass setup:admin-base-info-update final=`http://127.0.0.1:18080/admin/base-info` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-base-info-update.png`
- ✔ pass setup:admin-cache-clear final=`http://127.0.0.1:18080/admin/content/cache` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-cache-clear.png`
- ✔ pass setup:admin-maintenance-toggle final=`http://127.0.0.1:18080/admin/content/maintenance` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-maintenance-enable.png`
- ✘ fail setup:admin-member-maintenance final=`http://127.0.0.1:18080/admin/member-list?nameKeyword=Web%20E2E%20%E3%83%A1%E3%83%B3%E3%83%90%E3%83%BC%E5%89%8A%E9%99%A4%20qbca7p` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-member-maintenance.png` error=Error: member delete form action was not exposed for Web E2E メンバー削除 qbca7p: (empty)
- ✔ pass setup:admin-payment-maintenance-create final=`http://127.0.0.1:18080/admin/payment/payment?paymentId=3` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-payment-maintenance-create.png`
- ✔ pass setup:admin-payment-maintenance-update final=`http://127.0.0.1:18080/admin/payment/payment?paymentId=3` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-payment-maintenance-update.png`
- ✔ pass setup:admin-payment-maintenance-delete final=`http://127.0.0.1:18080/admin/payment/payment-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-payment-maintenance-delete.png`
- ✔ pass setup:admin-delivery-maintenance-create final=`http://127.0.0.1:18080/admin/delivery/delivery?deliveryId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-delivery-maintenance-create.png`
- ✔ pass setup:admin-delivery-maintenance-update final=`http://127.0.0.1:18080/admin/delivery/delivery?deliveryId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-delivery-maintenance-update.png`
- ✔ pass setup:admin-delivery-maintenance-delete final=`http://127.0.0.1:18080/admin/delivery/delivery-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-delivery-maintenance-delete.png`
- ✔ pass setup:admin-tax-rule-create final=`http://127.0.0.1:18080/admin/tax-rule/tax-rule-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-tax-rule-create.png`
- ✔ pass setup:admin-tax-rule-delete final=`http://127.0.0.1:18080/admin/tax-rule/tax-rule-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-tax-rule-delete.png`
- ✔ pass setup:admin-class-name-create final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-class-name-create.png`
- ✔ pass setup:admin-class-name-update final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-class-name-update.png`
- ✔ pass setup:admin-class-category-create final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-class-category-create.png`
- ✔ pass setup:admin-class-category-update final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-class-category-update.png`
- ✔ pass setup:admin-class-category-delete final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-class-category-delete.png`
- ✔ pass setup:admin-class-name-delete final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-class-name-delete.png`
- ✔ pass setup:admin-product-create final=`/admin/product?productCode=we-mq8ovkj2-e2liwc` screenshot=``
- ✔ pass setup:admin-product-readback final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8ovkj2-e2liwc` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-product-readback.png`
- ✔ pass setup:admin-product-csv-upload final=`http://127.0.0.1:18080/admin/product?productCode=we-csv-l3db4edv` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-product-csv-upload.png`
- ✔ pass setup:admin-product-update final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8ovkj2-e2liwc` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-product-update.png`
- ✔ pass setup:admin-product-copy final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8ovkj2-e2liwc-copy` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-product-copy.png`
- ✔ pass setup:admin-product-bulk-status final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8ovkj2-e2liwc-copy` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-product-bulk-status.png`
- ✔ pass setup:admin-product-delete-copy final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8ovkj2-e2liwc-copy` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-product-delete-copy.png`
- ✔ pass setup:admin-category-create final=`http://127.0.0.1:18080/admin/category/category?categoryId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-category-create.png`
- ✔ pass setup:admin-category-update final=`http://127.0.0.1:18080/admin/category/category?categoryId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-category-update.png`
- ✔ pass setup:admin-category-delete final=`http://127.0.0.1:18080/admin/category/category-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-category-delete.png`
- ✔ pass setup:admin-category-csv-upload final=`http://127.0.0.1:18080/admin/category/category-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-category-csv-upload.png`
- ✔ pass setup:admin-class-name-csv-upload final=`http://127.0.0.1:18080/admin/class-name/class-name-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-class-name-csv-upload.png`
- ✔ pass setup:admin-class-category-csv-upload final=`http://127.0.0.1:18080/admin/class-category/class-category-list?classNameId=1` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-class-category-csv-upload.png`
- ✔ pass setup:admin-tag-create final=`http://127.0.0.1:18080/admin/tag/tag-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-tag-create.png`
- ✔ pass setup:admin-tag-delete final=`http://127.0.0.1:18080/admin/tag/tag-list` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-tag-delete.png`
- ✔ pass setup:admin-customer-create final=`/admin/customer?email=admin-customer-20260611-admin-member-browser-regression-fixed2%40example.test` screenshot=``
- ✔ pass setup:admin-customer-readback final=`http://127.0.0.1:18080/admin/customer-list?emailKeyword=admin-customer-20260611-admin-member-browser-regression-fixed2%40example.test` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-customer-readback.png`
- ✔ pass setup:admin-customer-delete final=`http://127.0.0.1:18080/admin/customer-list?emailKeyword=admin-customer-20260611-admin-member-browser-regression-fixed2%40example.test` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-customer-delete.png`
- ✔ pass setup:admin-logout final=`/admin/login` screenshot=``
- ✔ pass setup:storefront-product-readback final=`http://127.0.0.1:18080/product?productCode=we-mq8ovkj2-e2liwc` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/storefront-product-readback.png`
- ✔ pass setup:non-member-purchase final=`http://127.0.0.1:18080/shopping/complete?orderNo=ff5aa2742601ad02b5b4f19b46a752e4` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/non-member-purchase-complete.png`
- ✔ pass setup:customer-login final=`http://127.0.0.1:18080/mypage` screenshot=``
- ✔ pass setup:member-purchase-history-reorder final=`http://127.0.0.1:18080/cart` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/member-reorder-cart.png`
- ✔ pass setup:admin-order-update final=`http://127.0.0.1:18080/admin/order?orderNo=7589e473118d5688f58474a165ba4e57` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-order-update.png`
- ✔ pass setup:admin-order-status-update final=`http://127.0.0.1:18080/admin/order?orderNo=7589e473118d5688f58474a165ba4e57` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-order-status-update.png`
- ✔ pass setup:admin-order-shipping-address-update final=`http://127.0.0.1:18080/admin/order/shipping-address?orderNo=7589e473118d5688f58474a165ba4e57` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-order-shipping-address-update.png`
- ✔ pass setup:admin-order-tracking-number-update final=`/admin/order/tracking-number?orderNo=7589e473118d5688f58474a165ba4e57&_method=put` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-order-tracking-number-update.png`
- ✔ pass setup:admin-order-shipping-csv-import final=`http://127.0.0.1:18080/admin/order/import-shipping` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-order-shipping-csv-import.png`
- ✔ pass setup:admin-order-shipping-notify-send final=`/admin/order/shipping-notify-mail` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-order-shipping-notify-send.png`
- ✔ pass setup:admin-order-mail-send final=`/admin/order/send-mail?orderNo=7589e473118d5688f58474a165ba4e57` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/admin-order-mail-send.png`
- ✔ pass setup:cart-quantity-and-delete final=`http://127.0.0.1:18080/cart` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/cart-quantity-and-delete.png`
- ✔ pass setup:customer-profile-favorite-address final=`http://127.0.0.1:18080/mypage` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/customer-profile-favorite-address.png`
- ✔ pass setup:customer-logout-and-relogin final=`http://127.0.0.1:18080/mypage` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/customer-logout-and-relogin.png`
- ✔ pass setup:contact-submit final=`http://127.0.0.1:18080/contact/complete?ticketId=INQ-6a29f1134de866.77460980` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/contact-submit.png`
- ✔ pass setup:password-reset-request final=`` screenshot=``
- ✔ pass setup:customer-withdraw final=`http://127.0.0.1:18080/mypage/withdraw-complete` screenshot=`screenshots/20260611-admin-member-browser-regression-fixed2/setup/customer-withdraw.png`
...
- 083 Admin 商品規格編集: ✘ fail（unsafe operation not executed: PUT /admin/product/product-class） final=`http://127.0.0.1:18080/admin/product?productCode=we-mq8ovkj2-e2liwc` reason=Browser navigation reached the page, but PUT /admin/product/product-class was not executed as an OK scenario.
...
- 142 Admin メンバー削除: ✘ fail（unsafe operation not executed: DELETE /admin/member） final=`http://127.0.0.1:18080/admin/member?loginId=workflow-admin-qbca7p` reason=Browser navigation reached the page, but DELETE /admin/member was not executed as an OK scenario.
