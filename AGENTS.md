...
This repository is artifact-first: [`alps.json`](alps.json) is the canonical ALPS profile, and the root-level [`alps.json.html`](alps.json.html), [`openapi.yaml`](openapi.yaml), and [`openapi.html`](openapi.html) are generated deliverables. [`docs/tag.md`](docs/tag.md) defines tag taxonomy, and [`docs/HANDOVER.md`](docs/HANDOVER.md) records provenance, coverage notes, and Pilot 1/2 completion reports. [`docs/`](docs/) contains the GitHub Pages site: [`docs/index.md`](docs/index.md) is the published article, while [`docs/alps.json.html`](docs/alps.json.html) and [`docs/openapi.html`](docs/openapi.html) mirror the published HTML artifacts. Files such as `verify-*.md` and `improvements-*.md` are working notes, not primary outputs.
