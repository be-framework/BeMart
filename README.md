...
- ストアフロント: <https://131.186.41.241.sslip.io/>（会員 `login-test@example.com` / `login-test-password-2026`）
- 管理画面: <https://131.186.41.241.sslip.io/admin/login>（`test-admin` / `admin-test-password-2026`、2FA は `123456`）
