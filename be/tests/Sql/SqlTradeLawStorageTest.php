...
/**
 * Storage-layer coverage for {@see SqlTradeLawStorage} (Phase 2b).
 *
 * Mirrors the shape of {@see SqlBaseInfoStorageTest} — TradeLaw is a
...
final class SqlTradeLawStorageTest extends AbstractSqlTestCase
{
    ...
    {
        $storage = $this->sql(SqlTradeLawStorage::class);
        $entity = $storage->get();
    ...
    public function testUpdateRoundTripsBodyWithNewlinesAndColonsLosslessly(): void
    {
        ...
        // this is why SqlTradeLawStorage stores the blob in a single
