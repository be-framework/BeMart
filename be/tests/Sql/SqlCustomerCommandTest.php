...
/**
 * Storage-layer coverage for {@see SqlCustomerCommand} (Phase 2b).
 *
 * Mirrors the shape of {@see SqlAdminCommandTest}'s write half. Per
 ...
 * column↔field projection {@see SqlCustomerQuery} reads back, so a
