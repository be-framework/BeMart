 ...
 *
 * Reads the payment verification and the computed $totals from the upstream chain
...
final readonly class OrderConfirming
{
    ...
    public function __construct(
        ...
        #[Input] PaymentVerification $paymentVerification,
    ) {
        $this->being = $paymentVerification->success
            ? new PaymentSuccessCase($totals)
            : new PaymentFailureCase($paymentVerification->errors);
    }
}
