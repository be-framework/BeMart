...
interface TwoFactorAuthInterface
{
     ...
     * current authentication step and `$secret` MUST be generated by the
     * server for that pending setup challenge, never raw client-supplied
     * values. This method overwrites any existing secret for `$loginId` with
     * no ownership check, so the adapter that drives
     * {@see \MyVendor\BeMart\Be\Final\TwoFactorAuthConfigured} is responsible
     * for binding both values to the just-authenticated login before reaching
     * this transition.
     */
