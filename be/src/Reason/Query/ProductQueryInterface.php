 ...
 * by the admin grid (`list`) and the admin filter search
 ...
 * unbounded values.
 *
 * Note: `list` returns ALL statuses including STATUS_WITHDRAWN so
...
interface ProductQueryInterface
{
     ...
     * `$nameKeyword` is null, behaves like `list($limit, 0)` for
