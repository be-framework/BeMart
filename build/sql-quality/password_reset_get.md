...
- **SQL File:** `password_reset_get.sql`
- **Cost:** 0.35
...
### EXPLAIN JSON
{"select_id":1,"cost_info":{"query_cost":"0.35"},"table":{"table_name":"dtb_customer","access_type":"ref","possible_keys":["idx_bemart_customer_reset_key"],"key":"idx_bemart_customer_reset_key","used_key_parts":["reset_key"],"key_length":"1023","ref":["const"],"rows_examined_per_scan":1,"rows_produced_per_join":1,"filtered":"100.00","using_index":true,"cost_info":{"read_cost":"0.25","eval_cost":"0.10","prefix_cost":"0.35","data_read_per_join":"28K"},"used_columns":["id","reset_key","reset_expire"]}}

### EXPLAIN ANALYZE
-> Limit: 1 row(s)  (cost=0.35 rows=1) (actual time=0.00446..0.00446 rows=0 loops=1)
    -> Covering index lookup on dtb_customer using idx_bemart_customer_reset_key (reset_key='reset-key-sample')  (cost=0.35 rows=1) (actual time=0.00396..0.00396 rows=0 loops=1)
