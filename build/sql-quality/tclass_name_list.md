...
### EXPLAIN JSON
{"select_id":1,"cost_info":{"query_cost":"0.75"},"ordering_operation":{"using_filesort":false,"table":{"table_name":"dtb_class_name","access_type":"index","key":"PRIMARY","used_key_parts":["id"],"key_length":"4","rows_examined_per_scan":5,"rows_produced_per_join":5,"filtered":"100.00","cost_info":{"read_cost":"0.25","eval_cost":"0.50","prefix_cost":"0.75","data_read_per_join":"15K"},"used_columns":["id","name"]}}}

### EXPLAIN ANALYZE
-> Index scan on dtb_class_name using PRIMARY  (cost=0.75 rows=5) (actual time=0.00392..0.00596 rows=5 loops=1)
