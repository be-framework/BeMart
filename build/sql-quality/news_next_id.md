...
### EXPLAIN ANALYZE
-> Zero input rows (No matching min/max row), aggregated into one output row  (cost=0..0 rows=1) (actual time=250e-6..292e-6 rows=1 loops=1)
