...
- **SQL File:** `customer_email_exists.sql`
- **Cost:** 0.35
...
### EXPLAIN JSON
{"select_id":1,"cost_info":{"query_cost":"0.35"},"table":{"table_name":"dtb_customer","access_type":"ref","possible_keys":["dtb_customer_email_idx"],"key":"dtb_customer_email_idx","used_key_parts":["email"],"key_length":"1022","ref":["const"],"rows_examined_per_scan":1,"rows_produced_per_join":1,"filtered":"100.00","using_index":true,"cost_info":{"read_cost":"0.25","eval_cost":"0.10","prefix_cost":"0.35","data_read_per_join":"28K"},"used_columns":["email"]}}

### EXPLAIN ANALYZE
-> Limit: 1 row(s)  (cost=0.35 rows=1) (actual time=0.00375..0.00383 rows=1 loops=1)
    -> Covering index lookup on dtb_customer using dtb_customer_email_idx (email='user1@example.com')  (cost=0.35 rows=1) (actual time=0.00358..0.00358 rows=1 loops=1)
