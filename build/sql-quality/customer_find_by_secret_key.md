...
- **SQL File:** `customer_find_by_secret_key.sql`
- **Cost:** 1.00
...
### EXPLAIN JSON
{"select_id":1,"cost_info":{"query_cost":"1.00"},"table":{"table_name":"dtb_customer","access_type":"const","possible_keys":["secret_key"],"key":"secret_key","used_key_parts":["secret_key"],"key_length":"1022","ref":["const"],"rows_examined_per_scan":1,"rows_produced_per_join":1,"filtered":"100.00","cost_info":{"read_cost":"0.00","eval_cost":"0.10","prefix_cost":"0.00","data_read_per_join":"28K"},"used_columns":["id","customer_status_id","sex_id","job_id","pref_id","name01","name02","kana01","kana02","company_name","postal_code","addr01","addr02","email","phone_number","birth","password","secret_key"]}}

### EXPLAIN ANALYZE
-> Limit: 1 row(s)  (cost=0..0 rows=1) (actual time=292e-6..334e-6 rows=1 loops=1)
