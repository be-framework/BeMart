...
### EXPLAIN JSON
{"select_id":1,"cost_info":{"query_cost":"2.25"},"ordering_operation":{"using_filesort":false,"table":{"table_name":"dtb_tag","access_type":"index","key":"PRIMARY","used_key_parts":["id"],"key_length":"4","rows_examined_per_scan":20,"rows_produced_per_join":20,"filtered":"100.00","cost_info":{"read_cost":"0.25","eval_cost":"2.00","prefix_cost":"2.25","data_read_per_join":"40K"},"used_columns":["id","name"]}}}

### EXPLAIN ANALYZE
-> Index scan on dtb_tag using PRIMARY  (cost=2.25 rows=20) (actual time=0.00304..0.00875 rows=20 loops=1)
