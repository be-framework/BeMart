...
final readonly class RouteTable
{
    ...
    private static function adminAliasRoutes(): array
    {
        return [
            ...
            self::adminPost('admin_content_block_new', 'page://self/admin/block/block-list'),
            self::adminGet('admin_content_block_edit', 'page://self/admin/block/block', ['id' => 'blockId']),
            self::adminPost('admin_content_block_edit', 'page://self/admin/block/block', 'put', ['id' => 'blockId']),
            ...
            self::adminPost('admin_content_layout_new', 'page://self/admin/layout/layout', 'put'),
            self::adminGet('admin_content_layout_edit', 'page://self/admin/layout/layout', ['id' => 'layoutId']),
            self::adminPost('admin_content_layout_edit', 'page://self/admin/layout/layout', 'put', ['id' => 'layoutId']),
            ...
            self::adminPost('admin_content_news_new', 'page://self/admin/news/news-list'),
            self::adminGet('admin_content_news_edit', 'page://self/admin/news/news', ['id' => 'newsId']),
            self::adminPost('admin_content_news_edit', 'page://self/admin/news/news', 'put', ['id' => 'newsId']),
            ...
            self::adminPost('admin_content_page_new', 'page://self/admin/page/page-list'),
            self::adminGet('admin_content_page_edit', 'page://self/admin/page/page', ['id' => 'pageId']),
            self::adminPost('admin_content_page_edit', 'page://self/admin/page/page', 'put', ['id' => 'pageId']),
            ...
            self::adminGetPost('admin_order_shipping', 'page://self/admin/order/shipping-address', ['id' => 'orderNo']),
            ...
            self::adminGetPost('admin_product_class_category', 'page://self/admin/class-category/class-category-list', ['class_name_id' => 'classNameId']),
            ...
            self::adminPost('admin_product_class_category_edit', 'page://self/admin/class-category/class-category', 'put', ['class_name_id' => 'classNameId', 'id' => 'classCategoryId']),
            ...
            self::adminPost('admin_product_class_category_sort_no_move', 'page://self/admin/sort-no-move', 'put', [], ['masterType' => 'class_category']),
            self::adminGet('admin_product_class_category_visibility', 'page://self/admin/action-redirect', [], ['returnTo' => '/admin/product/class_name']),
            self::adminPost('admin_product_class_category_visibility', 'page://self/admin/toggle-visible', 'put', ['id' => 'rowId'], ['masterType' => 'class_category']),
            ...
            self::adminPost('admin_product_class_name_sort_no_move', 'page://self/admin/sort-no-move', 'put', [], ['masterType' => 'class_name']),
            ...
            self::adminPost('admin_setting_shop_delivery_new', 'page://self/admin/delivery/delivery-list'),
            self::adminGet('admin_setting_shop_delivery_edit', 'page://self/admin/delivery/delivery', ['id' => 'deliveryId']),
            self::adminPost('admin_setting_shop_delivery_edit', 'page://self/admin/delivery/delivery', 'put', ['id' => 'deliveryId']),
            ...
            self::adminPost('admin_setting_shop_payment_new', 'page://self/admin/payment/payment-list'),
            self::adminGet('admin_setting_shop_payment_edit', 'page://self/admin/payment/payment', ['id' => 'paymentId']),
            self::adminPost('admin_setting_shop_payment_edit', 'page://self/admin/payment/payment', 'put', ['id' => 'paymentId']),
            ...
            self::adminPost('admin_setting_system_member_new', 'page://self/admin/member'),
            self::adminGet('admin_setting_system_member_edit', 'page://self/admin/member', ['id' => 'loginId']),
            self::adminPost('admin_setting_system_member_edit', 'page://self/admin/member', 'put', ['id' => 'loginId']),
